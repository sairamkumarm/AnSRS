...
@CommandLine.Command(name = "complete", description = "marks problem as completed")
public class CompleteCommand implements Runnable{

    @CommandLine.ParentCommand
    private SRSCommand parent;

    @CommandLine.Parameters(index = "0", paramLabel = "ID", description = "Problem ID")
    private int problemId;

    @CommandLine.Option(names = {"-u", "--update"}, paramLabel = "POOL", description = "Pool value update for problem, choose from H M and L", required = false)
